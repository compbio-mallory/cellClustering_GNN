...
def ARI(ground_truth_numeric, predicted_clusters) -> float:
  return metrics.adjusted_rand_score(ground_truth_numeric, predicted_clusters)

def NMI(ground_truth_numeric, predicted_clusters) -> float:
  return metrics.normalized_mutual_info_score(ground_truth_numeric, predicted_clusters)