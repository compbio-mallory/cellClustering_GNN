...
# Runs grid search over multiple architecture settings
...
for ARCH in "${ARCH_LIST[@]}"; do
    # Make safe log filename (replace commas with underscores)
    ARCH_SAFE=$(echo "$ARCH" | tr ',' '_')
    LOG_FILE="../simulation_benchmarking_0816_arch${ARCH_SAFE}.log"
